...
> con_to_postgres - here's a functions that python interacts with potsgresql and outputs a lot of data via: title, name, category and search
___

### tg_bot.py
> Telegram bot, working true con_to_postgres.py using Postgresql with Databases
